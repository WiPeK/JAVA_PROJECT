...
public class AdminStatisticsController {
    ...
    private LineChart<String, Number> getAvgStats() {
        ...
        Set<SchoolYearsNH> newSet = new HashSet<>(0);
        ...
        for (Object schYrsObject : schYrsObjects) {
            ...
            for (SemestersNH x : sem) {
                ...
                for (CarriedSubjectsNH carriedSubjectsNH : nazwa.getCarriedSubjects()) {
                    Double semesterAverage = carriedSubjectsNH.getGrades().parallelStream().mapToDouble(GradesNH::getEndGrade).average().getAsDouble();
                    semestersAvg.add(semesterAverage);
                }
        ...
        for (Object stat : schYrsObjects) {
            ...
            i++;
            System.out.println(yearsAvg.get(i-1));
        }
